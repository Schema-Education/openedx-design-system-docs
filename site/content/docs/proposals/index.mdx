---
title: ODS-RFCs — Open edX Design System Proposals
description: RFC-style proposals for product, feature, UX, and development changes to the Open edX Design System.
---
...
|---|---|---|---|---|
| [0001](/docs/proposals/0001-mfe-component-registry) | Component Registry Manifest & MFE Atomic-Level Classification | draft | proposal | 2026-05-19 |

## Adding a New Proposal

1. Copy [`TEMPLATE.mdx`](https://github.com/Schema-Education/openedx-design-system-docs/blob/main/site/content/docs/proposals/TEMPLATE.mdx) to a new file: `NNNN-kebab-title.mdx`, using the next available four-digit number.
